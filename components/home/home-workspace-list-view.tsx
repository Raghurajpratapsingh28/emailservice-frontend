  ...
  return (
    <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="space-y-6 max-w-[1200px] mx-auto select-none">
      <div>
        ...
        <p className="text-xs text-[#7A8499] mt-1.5">Select a workspace to view its dashboard.</p>
      </div>
      <div className="grid gap-4">
        ...
        {workspaces.length === 0 && (
          <div className="p-12 rounded-3xl bg-[#0F1016]/95 border border-[#1C202C] flex flex-col items-center text-center">
            <div className="w-12 h-12 rounded-2xl bg-[#6B7280]/10 border border-[#6B7280]/25 flex items-center justify-center mb-4"><LayoutDashboard className="w-6 h-6 text-[#6B7280]" /></div>
