...
export default function TransactionalWorkspaceListView() {
  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-xs text-[#8A8D96] mt-1.5 font-medium">Select a workspace to manage its transactional emails.</p>
      </div>
