  ...
  return (
    ...
    >
      <div>
        ...
        <h1 className="text-3xl font-extrabold tracking-tight text-white/95 mt-1">Integrations</h1>
        <p className="text-xs text-[#7A8499] mt-1.5">
      ...
      <div className="grid gap-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#7A8499] font-mono mt-0.5">
        ...
        {workspaces.length === 0 && (
          <div className="p-12 rounded-3xl bg-[#0F1016]/95 border border-[#1C202C] flex flex-col items-center text-center">
            ...
            <p className="text-xs text-[#B0B8C8] mt-1.5">
