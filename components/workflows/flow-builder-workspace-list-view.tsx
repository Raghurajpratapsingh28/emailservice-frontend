  ...
  return (
    <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="space-y-6 max-w-[1200px] mx-auto select-none">
      <div>
        ...
        <h1 className="text-3xl font-extrabold tracking-tight text-white/95 mt-1">Flow Builder</h1>
        <p className="text-xs text-[#7A8499] mt-1.5">Select a workspace to manage its workflows.</p>
      </div>
